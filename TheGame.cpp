...
⠄⠄⠄⠄⠄⠈⠙⠑⣠⣤⣴⡖⠄⠿⣋⣉⣉⡁⠄⢾⣦⠄⠄⠄⠄⠄⠄⠄⠄
	...
	cout << "                 (c) 2025 CodeArt / FCAI-CU . All Rights Reserved.\n\n";
        ...
        try {
            ...
            if (choice < 1 || choice > 15) {
                throw out_of_range("Choice must be an integer between 1 and 15.");
            }
            ...
            switch (choice) {
                ...
                case 13:
                    ...
                    break;
                case 14:
                    game_ui = new dia_XO_UI();
                    game_board = new dia_XO_Board();
                    break;
                default:
